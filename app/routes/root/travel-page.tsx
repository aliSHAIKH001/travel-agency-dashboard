...
const FeaturedDestination = ({containerClass="", bigCard=false,
                                 rating, title, activityCount, bgImage}: DestinationProps) => (
    <section className={cn("rounded-[14px] overflow-hidden bg-cover" +
        " bg-center size-full min-w-[280px]", containerClass, bgImage, )}>
        <div className="bg-linear200 h-full">
            <article className="featured-card">
                <div className={cn("bg-white rounded-20 font-bold" +
                    " text-red-100 w-fit py-px px-3 text-sm")}>
                    {rating}
                </div>
...
const TravelPage = ({loaderData}: Route.ComponentProps ) => {
    ...
    return (
        <main className="flex flex-col">
            {/*This section represents the hero section*/}
            ...
            {/*This section represents the featured destinations section*/}
            ...
            {/*This section represents handpicked trips*/}
            <section id="trips" className="py-20 wrapper flex flex-col gap-10">
                <Header title="Handpicked Trips"
                        description="Browse well-planned trip designs for your travel style" />
