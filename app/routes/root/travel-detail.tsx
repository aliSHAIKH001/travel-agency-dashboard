...
import {cn, getFirstWord, parseTripData, rateTrip} from "~/lib/utils";
...
export const loader = async ({params}: LoaderFunctionArgs) => {
    ...
    return {
        trip,
        // tripDetail attribute inside each trip inside allTrips is spread so it can be used later on in the last section.
...
const TravelDetail = ({loaderData}: Route.ComponentProps ) => {
    ...
    const rating = rateTrip(tripData!);
        ...
        <main className="travel-detail pt-40 wrapper">
            <div className="travel-div">
                ...
                <section className="container wrapper-md">
                    ...
                    {/*This section represents the heading and the two pills*/}
                    <header>
                        ...
                        <div className="flex items-center gap-5">
                            <InfoPill
                                ...
                                image="/assets/icons/new-calender.svg"
                            />
                            <InfoPill
                    ...
                    {/*This section represents the images.*/}
                    ...
                    {/*This section represents the travel-chips, the stars and the dynamic rating.*/}
                    ...
                    {/*This section represents the type of trip and the estimated price*/}
                    ...
                    {/*This ul represents each day in the trip and the following activities of that day*/}
                    ...
                    {/*This section shows best time to visit and weather info*/}
                    ...
                    <a href="">
                        <ButtonComponent className="button-class">
            ...
            {/*This section shows all the popular trips*/}
