...
const CreateTrip = ({loaderData}: Route.ComponentProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // The duration of the trip must not exceed 10 and must not be below 1
            ...
            <section className="mt-2.5 wrapper-md">
                <form className="trip-form" onSubmit={handleSubmit}>
                    <div>
                        ...
                        {/* In ComboBoxComponents, the value in fields is like the underlying ID.*/}
                       <ComboBoxComponent
                           id="country"
                        ...
                        <div key={key}>
                            ...
                            <ComboBoxComponent
                                ...
                                filtering={(e) => {
                                    const query = e.text.toLowerCase()
                                    e.updateData(
                                        comboBoxItems[key].filter((item) => item.toLowerCase().includes(query))
                                            .map((item) => ({
                                                text: item,
                                                value: item,
                                            }))
